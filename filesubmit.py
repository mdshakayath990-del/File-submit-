...
# আপনি যেই চ্যানেলে এড করতে চান, সেই চ্যানেলে Rose বট এড করে /id লিখলে -100 দিয়ে শুরু আইডি পেয়ে যাবেন। সেটি এখানে বসান।
...
SYSTEM_SETTINGS = {
    ...
    "welcome_msg": "📌 *কীভাবে ID জমা দেবেন:*\n1️⃣ *SELL ID* বাটন চাপুন\n2️⃣ ক্যাটাগরি সিলেক্ট করুন\n3️⃣ Excel (.xlsx) ফাইল আপলোড করুন\n4️⃣ আপনার Telegram username দিন\n5️⃣ Payment মেথড ও নম্বর দিন\n✅ সাবমিট সম্পন্ন — Admin result জানাবে",
    "notice_board": "",
    "pay_bkash": True,  # Payment Toggle
    "pay_nagad": True   # Payment Toggle
}
